"""
Django settings for edu_website project.
...
ALLOWED_HOSTS = ['dustudents.herokuapp.com','127.0.0.1']
...
WSGI_APPLICATION = 'edu_website.wsgi.application'
